;anasm.asm
GLOBAL  api_putchar,api_end, api_putstr0, api_openwin, api_putstrwin, api_boxfilwin
GLOBAL 	api_initmalloc, api_malloc, api_free, api_point, api_linewin, api_refreshwin, api_closewin, api_getkey
